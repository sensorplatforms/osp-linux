...
#ifndef OSPIIOSENSOR_H_
#define OSPIIOSENSOR_H_
 ...
 */
class OSPIIOSensor : public SensorBase {
public:
    OSPIIOSensor(const char* iioname, int32_t sensorId, int32_t sensorType, bool evtFloat);
    virtual ~OSPIIOSensor();
...
protected:
    OSPIIOSensor();
    OSPIIOSensor(const OSPIIOSensor&);
    void operator=(const OSPIIOSensor&);
