...
#define FIFO_MAX_EC_LIN_ACCEL	(250)
...
#define FIFO_MAX_EC_MAG_UNCAL	(250)
...
#define FIFO_MAX_EC_GAME_RV	(250)
...
#define FIFO_MAX_EC_GYRO_UNCAL	(250)
...
#define FIFO_MAX_EC_SIG_MOT	(0)
#define FLAGS_SIG_MOT		(SENSOR_FLAG_ONE_SHOT_MODE | SENSOR_FLAG_WAKE_UP)
...
#define FIFO_MAX_EC_STEP_DET	(250)
...
#define FIFO_MAX_EC_STEP_COUNT	(250)
