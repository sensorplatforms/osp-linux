...
#define SH_CONFIG_READ_STORE "/sys/bus/i2c/devices/2-0018/sensorhub_config_read"
#define SH_CONFIG_WRITE_STORE "/sys/bus/i2c/devices/2-0018/sensorhub_config_write"
